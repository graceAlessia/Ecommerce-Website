    ...
    <div class="row" style="min-height: 1000px">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <?php if (isset($_GET['delete_fail'])) { ?>
                <p class="text-center" style="color: red;"><?php echo $_GET['delete_fail'] ?></p>
            <?php } ?>
                    ...
                    <tbody>
                        <?php while ($product = $products->fetch_assoc()) { ?>
                            <tr>
                                ...
                                <td><a class="btn btn-secondary" href="<?php echo "edit_images.php?product_id=" . $product['product_id'] . "& product_name=" . $product['product_name']; ?>">Edit Images</a></td>
                                <td><a class="btn btn-secondary" href="edit_product.php?product_id=<?php echo $product['product_id']; ?>">Edit</a></td>
                                <td><a class="btn btn-dark" href="delete_product.php?product_id=<?php echo $product['product_id']; ?>">Delete</a></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
