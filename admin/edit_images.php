        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <div class="table-responsive">
                <div class="mx-auto container">
                    <form id="edit-order-form" enctype="multipart/form-data" method="POST" action="update_images.php">
                        ...
                        <div class="form-group mt-3">
                            <input type="submit" name="update_images" class="btn btn-primary" value="Update Images">
                        </div>
