...
<div class="container-fluid">
    <div class="row" style="min-height: 1000px">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <?php } ?>
            <?php if (isset($_GET['order_delete_success'])) { ?>
                <p class="text-center" style="color: green;"><?php echo $_GET['order_delete_success'] ?></p>
            <?php } ?>

            <?php if (isset($_GET['order_delete_fail'])) { ?>
                <p class="text-center" style="color: red;"><?php echo $_GET['order_delete_fail'] ?></p>
            <?php } ?>
                    ...
                    <tbody>
                        <?php while ($order = $orders->fetch_assoc()) { ?>
                            <tr>
                                ...
                                <td><a class="btn btn-secondary" href="edit_order.php?order_id=<?php echo $order['order_id']; ?>">Edit</a></td>
                                <td><a class="btn btn-dark" href="delete_order.php?id=<?php echo $order['order_id']; ?>">Delete</a></td>
