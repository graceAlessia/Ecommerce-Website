                ...
                <div class="mx-auto container">
                    <form id="create-form" enctype="multipart/form-data" method="POST" action="create_product.php">
                        ...
                        <div class="form-gorup mt-2">
                            ...
                            <input type="text" class="form-control" id="priduct_special_offer" name="special_offer" placeholder="Sale %" required>
                        </div>
                        ...
                        <div class="form-group mt-3">
                            <input type="submit" class="btn btn-primary" name="create_product" value="Save">
                        </div>
